-- User
INSERT INTO vibent_back_dev.user (id, ref, email, first_name, last_name, phone_number, deleted, profile_pic_location,
...
-- Group
INSERT INTO vibent_back_dev.group_t (id, ref, name, description, image_path, has_default_admin, deleted)
...
-- Group Membership
INSERT INTO vibent_back_dev.membership (id, user_id, group_id, admin, deleted, date)
...
-- Event
INSERT INTO vibent_back_dev.event (id, ref, group_id, title, description, start_date, end_date, deleted)
...
-- Event Participation
INSERT INTO vibent_back_dev.event_participation (id, user_id, event_id, answer, is_visible, deleted)
...
-- Alimentation
INSERT INTO vibent_back_dev.alimentation_bubble (id, event_id, user_id, deleted)
VALUES (1, 1, 1, 0);
INSERT INTO vibent_back_dev.alimentation_entry (id, bubble_id, name, total_requested, type, deleted)
VALUES (1, 1, 'Cola', 5, 'DRINK', 0),
       (2, 1, 'Mountain Dew', 10, 'DRINK', 0),
       (3, 1, 'Hambugers', 12, 'FOOD', 0),
       (4, 1, 'Cheetos', 10, 'FOOD', 0),
       (5, 1, 'Saucisson', 15, 'FOOD', 0);
INSERT INTO vibent_back_dev.alimentation_bring (id, entry_id, user_id, quantity, deleted)
VALUES (1, 1, 1, 1, 0),
       (2, 1, 2, 1, 0),
       (3, 2, 3, 5, 0),
       (4, 2, 1, 3, 0),
...
-- Checkbox
INSERT INTO vibent_back_dev.checkbox_bubble (id, title, event_id, user_id, deleted)
VALUES (1, 'Things to bring', 1, 1, 0);

INSERT INTO vibent_back_dev.checkbox_option (id, bubble_id, user_id, content, deleted)
...
INSERT INTO vibent_back_dev.checkbox_answer (id, user_id, option_id, deleted)
VALUES (1, 1, 2, 0),
       (2, 1, 5, 0),
       (3, 2, 4, 0),
       (4, 3, 3, 0);
...
-- Free
INSERT INTO vibent_back_dev.free_bubble (id, title, content, event_id, user_id, deleted)
VALUES (5, 'Kevin Birthday', 'Hey guys, it''s Kevin''s Birthday on sunday so make sure to bring presents !', 1, 1, 0);

-- Planning
INSERT INTO vibent_back_dev.planning_bubble (id, title, event_id, user_id, deleted)
VALUES (1, 'Weekend planning', 1, 1, 0);

INSERT INTO vibent_back_dev.planning_entry (id, start, end, content, has_time, bubble_id, user_id, deleted)
...
-- Survey
INSERT INTO vibent_back_dev.survey_bubble (id, title, event_id, user_id, deleted)
VALUES (1, 'Particular dietary plan ?', 1, 1, 0);

INSERT INTO vibent_back_dev.survey_option (id, bubble_id, user_id, content, deleted)
VALUES (1, 1, 1, 'None', 0),
       (2, 1, 1, 'Vegetarian', 0),
       (3, 1, 1, 'Flexitarian', 0),
       (4, 1, 1, 'Halal', 0);

INSERT INTO vibent_back_dev.survey_answer (id, user_id, option_id, deleted)
VALUES (1, 1, 1, 0),
       (2, 2, 1, 0),
       (3, 3, 2, 0),
       (4, 4, 2, 0),
...
-- Travel
INSERT INTO vibent_back_dev.travel_bubble (id, event_id, user_id, deleted)
VALUES (1, 1, 1, 0);

INSERT INTO vibent_back_dev.travel_proposal (id, bubble_id, user_id, capacity, pass_by_cities, deleted)
...
INSERT INTO vibent_back_dev.travel_request (id, user_id, bubble_id, capacity, proposal_id, pass_by_cities, deleted)
